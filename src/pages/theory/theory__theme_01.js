export default function theory_Theme_01() {
...
<div class="main">
    ...
    <h1 class="main__title-1">01: Введение</h1>
        
        <h3 class="main__title-3">Уроки</h3>
        <!----- Lessons ----->
        <ul class="main__list-1">
        <li class="main__list-1-item">
            <a class="main__link-default" href="/theory/theme_01/lesson_01">01. Введение</a>
        </li>
        <li class="main__list-1-item">
            <a class="main__link-default" href="/theory/theme_01/lesson_02">02. Как выполнять код</a>
        </li>
